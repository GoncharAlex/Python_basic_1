...
finish_list_1 = [el for el in number_list if el > number_list[(number_list.index(el) - 1)] and el != number_list[0]]
...
my_list = [number for number in range(20, 240) if number % 20 == 0]
print(my_list)
...
random_list_2 = [el for el in range(100, 1001) if el % 2 == 0]
print(random_list_2)
print(reduce(my_func, random_list_2))
...
random_list_3 = ['hello', 'world']
exit_flag = 0
for el in cycle(random_list_3):
    if exit_flag > 20:
        break
    else:
        print(el)
